...
const heroPillars = [
  {
    id: "all",
    label: "Grassroots Mission",
    icon: Globe2,
    badge: "Grassroots Mission",
    title: "Serving Humanity.",
    accent: "Empowering Lives.",
    body: "Grassroots relief, education, healthcare access, animal welfare, and ecological restoration across Forbesganj, Araria, and Bihar.",
    image: images.heroCommunity,
    alt: "Trinetra Foundation volunteers working with local community families in Forbesganj, Araria, Bihar",
  ...
  },
  {
    ...
    image: workEducation,
    alt: "Children studying at Trinetra Foundation community education centre in Bihar",
    stat: "500+ Students",
  ...
  },
  {
    ...
    body: "Daily community kitchens, emergency ration drives, and hot meals delivered directly to destitute households in Forbesganj and Araria.",
    image: workFood,
    alt: "Cooked meal and food relief distribution by Trinetra Foundation in Forbesganj, Bihar",
    stat: "10,000+ Meals",
  ...
  },
  {
    ...
    body: "Free specialist diagnostic camps, emergency medicine aid, and maternal-child health across rural hamlets in Araria district.",
    image: workHealth,
    alt: "Community health checkup camp and medical assistance in Araria district, Bihar",
  ...
  },
  {
    ...
    body: "Gaushala shelter care, veterinary rescue operations, massive tree plantations, and clean water harvesting in Bihar.",
    image: workAnimal,
    alt: "Gaushala animal care and tree plantation environmental initiative in Bihar",
    stat: "Gaushala Care",
